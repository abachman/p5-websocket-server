...
var SocketCollection = /*#__PURE__*/function () {
  function SocketCollection() {
    _classCallCheck(this, SocketCollection);

    this.connections = {};
  }

  _createClass(SocketCollection, [{
    key: "addConnection",
    value: function addConnection(conn, req, uid) {
      var ip;
